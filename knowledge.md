...
|Identity request failure - SSL (2) | Running `composer identity request` command yields "error Error: failed to request identity. Error trying to enroll user and return certificates. Error: Calling enrollment endpoint failed with error [Error: write EPROTO 139748722722624:error:140770FC:SSL routines:SSL23_GET_SERVER_HELLO:unknown protocol:../deps/openssl/openssl/ssl/s23_clnt.c:797:  
]"  **Resolution:** its likely you have `https` set for the `"ca":`URL entry - see above for resolution
